...
import { ChevronRight, Home, Download, ArrowLeft, FileText } from 'lucide-react';
...
export const ArticleView: React.FC<ArticleViewProps> = ({
  ...
  // PDF file path
  const pdfUrl = article.pdfUrl || '/pdf/How_To_Assign_Counsellor_and_Tags.pdf';
  ...
  return (
    <div className="py-6 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto space-y-6">
      ...
      {/* Top Header Card with Download Button */}
      ...
      {/* NATIVE REAL EMBEDDED PDF VIEWER CONTAINER */}
